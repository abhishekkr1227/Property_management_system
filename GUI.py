...
def login_in():
	...
	orionLabel=Label(login_menu, text="PROPERTY MANAGMENT SYSTEM",bg='plum1',font=("Castellar", "23","bold","italic","underline"),fg="black")
	subLabel=Label(login_menu, text="BY Abhishek And Ashutosh",font=("Castellar", "16","bold","italic"))
...
def Main_Menu():
	...
	base.wm_title("Abhishek And Ashutosh property dealers")
	...
	#Buttons
	borrow_but=Button(bottomFrame,bg="purple4",fg="white",text="Rent Property",font=in_font,height=5,width=17,command=borrow_in)
